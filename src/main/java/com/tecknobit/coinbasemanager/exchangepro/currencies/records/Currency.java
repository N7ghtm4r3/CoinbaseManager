package com.tecknobit.coinbasemanager.exchangepro.currencies.records;
...
public class Currency {
    ...
    public static class CurrencyDetails {
        ...
        public CurrencyDetails(JSONObject currencyDetails) {
            ...
            pushPaymentMethodsList = loadDetailsList(hCurrency.getJSONArray("push_payments", new JSONArray()));
